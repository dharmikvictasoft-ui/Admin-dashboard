      ...
      >
        <div className="flex items-center justify-between pb-3 mb-3 border-b border-gray-100 dark:border-gray-700">
          ...
          <button
            ...
            className="text-gray-500 z-10 transition dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200"
          >
            <svg
              className="fill-current"
              width="24"
        ...
        <ul className="flex flex-col h-auto overflow-y-auto custom-scrollbar z-[9999]">
